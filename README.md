...
**The numbers:**
- **87%** of AI-generated PRs contain at least one vulnerability (DryRun Security, 30 PRs across Claude/Codex/Gemini)
- **62%** of AI code ships with vulnerabilities (OX Security / CSA)
- **100%** of tested AI-generated apps had SSRF — **0%** had security headers (Tenzai Security, 15 apps across 5 tools)
- **2.74×** more XSS, **1.91×** more IDOR, **~2×** more secrets exposure vs human-written code (Veracode GenAI Code Security Report, 2025)
- **37%** more critical vulnerabilities after 5 rounds of AI refinement — more prompting makes it worse (arxiv:2506.11022)
