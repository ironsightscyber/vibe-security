...
**The numbers:** 87% of AI-generated PRs contain at least one vulnerability (DryRun Security, 30 PRs across Claude/Codex/Gemini). 62% of AI code ships with vulnerabilities (OX Security / CSA). 100% of tested AI-generated apps had SSRF; 0% had security headers (Tenzai Security, 15 apps across 5 tools). AI code is 2.74× more likely to contain XSS, 1.91× more likely to have IDOR, and ~2× more likely to leak secrets than equivalent human-written code (Veracode GenAI Code Security Report, 2025).
