...
| CVE-2026-21852 | CVSS 5.3 | Claude Code (fixed Dec 2025) | `ANTHROPIC_BASE_URL` in settings redirects all API calls (including API key) to attacker server before trust prompt. |
